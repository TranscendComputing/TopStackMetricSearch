...
public class MarshallingUtils extends MarshalUtil
{
        ...
        Metric metric)
    {
        ...
        MarshallingUtils.marshallDimensionList(nodeMetric,
            MonitorConstants.NODE_DIMENSIONS, metric.getDimensionList());
        ...
        MetricAlarm alarm)
    {
        ...
        MarshallingUtils.marshallStringList(nodeMetricAlarm,
            MonitorConstants.NODE_ALARMACTION, alarm.getAlarmActionList(),
      ...
      //      alarm.getAlarmConfigurationUpdatedTimestamp());
        ...
        MarshallingUtils.marshallString(nodeMetricAlarm,
            MonitorConstants.NODE_COMPARISONOPERATOR, alarm.getComparisonOperator().toString());
        MarshallingUtils.marshallDimensionList(nodeMetricAlarm,
            MonitorConstants.NODE_DIMENSIONS, alarm.getDimensionList());
        ...
        MarshallingUtils.marshallStringList(nodeMetricAlarm,
            ...
            alarm.getInsufficientDataActionList(),
        ...
        MarshallingUtils.marshallStringList(nodeMetricAlarm,
            MonitorConstants.NODE_OKACTIONS, alarm.getOKActionList(),
     ...
     //       alarm.getStateUpdatedTimestamp());
        MarshallingUtils.marshallString(nodeMetricAlarm,
            MonitorConstants.NODE_STATEVALUE, alarm.getStateValue().toString());
        MarshallingUtils.marshallString(nodeMetricAlarm,
            MonitorConstants.NODE_STATISTIC, alarm.getStatistic().toString());
            ...
            String nodeName, AlarmHistoryItem ahi)
    {
        ...
        MarshallingUtils.marshallString(nodeAlarmHistoryItem,
                MonitorConstants.NODE_ALARMHISTORYITEMTYPE, ahi.getHistoryItemType().toString());
        MarshallingUtils.marshallString(nodeAlarmHistoryItem,
