...
public class PutServiceHealthEventWorker extends AbstractAction<Object>
{
    private static final Logger logger = Appctx.getLogger(PutServiceHealthEventWorker.class
        .getName());
